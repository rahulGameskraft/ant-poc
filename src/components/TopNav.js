...
const TopNav = (props)=>{
    ...
    return (
        <>
            <Row justify={'space-between'} align={'middle'} style={{position:'relative',height:'5vh',width:'100%',borderBottom:'1px solid rgb(242, 245, 249)', padding:0}}>
            ...
            <Menu 
                ...
                items={items} 
                style={{position:"relative", height:'5vh'}}
            />
        </>
    )
