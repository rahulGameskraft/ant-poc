...
const TablerLayout = (props) => {
    ...
    return (
        <div style={{backgroundColor:"rgb(242,245,249)", height:'90vh', overflow:"overlay",marginLeft:120, paddingRight:120}}>

            <Row style={{marginTop:90,}}>
                <Col style={{width:'23.5%'}}><ProgressCard /></Col>
                <Col style={{width:'23.5%', marginLeft:16}}><ProgressCard /></Col>
                <Col style={{width:'23.5%', marginLeft:16}}><ProgressCard /></Col>
                <Col style={{width:'23.5%', marginLeft:16}}><ProgressCard /></Col>
            </Row>
            <Row style={{marginTop:20}}>
                <Col style={{width:'23.5%'}}><IconCard rowText1={'132 Sales'} rowText2={'12 waiting payments'} avatar={<Avatar shape="square" style={{backgroundColor:'rgb(32,107,196)', color:'#fff', width:40, height:40}}><DollarOutlined style={{fontSize:25, marginTop:6}}/></Avatar>}/></Col>
                <Col style={{width:'23.5%', marginLeft:16}}><IconCard avatar={<Avatar shape="square" style={{backgroundColor:'rgb(29,161,242)', color:'#fff', width:40, height:40}}><TwitterOutlined style={{fontSize:25, marginTop:6}}/></Avatar>} rowText1={'623 Shares'} rowText2={'16 Today'}/></Col>
                <Col style={{width:'23.5%', marginLeft:16}}><IconCard avatar={<Avatar shape="square" style={{backgroundColor:'rgb(29,161,242)', color:'#fff', width:40, height:40}}><FacebookOutlined style={{fontSize:25, marginTop:6}}/></Avatar>} rowText1={'132 Likes'} rowText2={'21 Today'}/></Col>
                <Col style={{width:'23.5%', marginLeft:16}}><IconCard avatar={<Avatar shape="square" style={{backgroundColor:'rgb(47,179,68)', color:'#fff', width:40, height:40}}><svg style={{marginTop:6}} xmlns="http://www.w3.org/2000/svg" className="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M6 19m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0"></path><path d="M17 19m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0"></path><path d="M17 17h-11v-14h-2"></path><path d="M6 5l14 1l-1 7h-13"></path></svg></Avatar>} rowText1={'78 Orders'} rowText2={'23 Shipped'}/></Col>
            </Row>
            <Row style={{marginTop:20}}>
                <Col style={{width:'calc(48.3%)',}} >
                    <Card title={"Alerts"}>
                        <AntList />
                    </Card>
                </Col>
                <Col style={{width:'calc(48.3%)', marginLeft:16}}>
                    <TaskList />
                </Col>
            </Row>
            <Row style={{marginTop:20, paddingBottom:70}}>
                <Col style={{width:'97.9%'}}>
                    <Card
                        title={'Past Alerts'}
                    >
                        <AntExpandableTable />
